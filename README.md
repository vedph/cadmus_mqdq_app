...
2. `docker build . -t vedph2020/cadmus-mqdq-app:1.0.21 -t vedph2020/cadmus-mqdq-app:latest` (replace with the current version)
...
3. `docker build . -t vedph2020/cadmus-mqdq-app:1.0.27-prod`.
