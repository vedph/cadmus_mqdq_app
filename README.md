...
Quick Docker image build (ensure you have built with `ng build --prod`): `docker build . -t vedph2020/cadmus-mqdq-app:1.0.4 -t vedph2020/cadmus-mqdq-app:latest` (replace with the current version).
